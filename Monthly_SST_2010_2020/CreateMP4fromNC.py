...
output_video = 'modis_SST_2010_2020.mp4'
...
print("=" * 60)
print("MODIS SST Animation Generator")
print("=" * 60)
...
# Add colorbar
cbar = plt.colorbar(im, ax=ax, label='Nighttime Sea Surface Temperature (Degrees C)', pad=0.02)

# Labels
ax.set_xlabel('Longitude (°E)', fontsize=12)
ax.set_ylabel('Latitude (°N)', fontsize=12)
ax.set_title('MODIS Aqua Nightime SST ', fontsize=14, weight='bold', pad=20)
...
writer = animation.FFMpegWriter(
    ...
    metadata=dict(
        ...
        title='MODIS Nightime SST 2010-2020',
