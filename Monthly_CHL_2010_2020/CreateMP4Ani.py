#!/usr/bin/env python3
"""
Create MP4 animation from MODIS Level 3 Chlorophyll data (2010-2020)
"""
...
output_video = 'modis_chlorophyll_2010_2020_bering_sea.mp4'

# Video settings
fps = 5  # Frames per second
dpi = 150  # Resolution

# Chlorophyll color scale (mg/m³)
vmin = 0.01
vmax = 10.0
...
print("=" * 60)
print("MODIS Chlorophyll Animation Generator")
print("=" * 60)
...
def extract_date_from_filename(filename):
    """Extract start date from AQUA_MODIS.20100101_20100131.L3m.MO format"""
...
possible_names = ['chlor_a', 'chlor', 'CHL', 'chl', 'chlorophyll']
chl_var = None
...
if chl_var is None:
    print("\nERROR: Could not find chlorophyll variable!")
    print("Please check variable names above and modify the script.")
    exit(1)
...
#Create bounding for bering sea 
extent = [160.0, 190.0, 52.0, 66.0] 
...
# Add colorbar
cbar = plt.colorbar(im, ax=ax, label='Chlorophyll-a (mg/m³)', pad=0.02)

# Labels
ax.set_xlabel('Longitude (°E)', fontsize=12)
ax.set_ylabel('Latitude (°N)', fontsize=12)
ax.set_title('MODIS Aqua Chlorophyll-A Bering Sea Concentration', fontsize=14, weight='bold', pad=20)
...
writer = animation.FFMpegWriter(
    ...
    metadata=dict(
        ...
        title='MODIS Chlorophyll-a 2010-2020_Bering_Sea',
        comment='Created from MODIS Aqua Level 3 data'
    ),
    bitrate=2000,
    codec='libx264'
)
